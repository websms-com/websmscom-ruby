...
class SmsClient
  ...
  def sendTextSms(text_message,max_sms_per_message=1,test=false)
    ...
    sms_send_request.senderAddressType = text_message.sender_address_type.downcase
  ...
  def sendBinarySms(binary_message,
    ...
    sms_send_request.senderAddressType = binary_message.sender_address_type.downcase
