...
class SmsClient
  ...
  def sendBinarySms(binary_message,
    ...
    sms_send_request.senderAddressType = (binary_message.sender_address_type.nil?) ? binary_message.sender_address_type : binary_message.sender_address_type.downcase
